...
//                           onChanged: (value) async {
//                             if(lightvalue=value!) {
//                               value =await themeProvider?.setThemeMode(ThemeMode.light) ?? false;
//                               systemvalue=false;
//                               darkvalue=false;
//                               // lightvalue=value!;
//                             }
...
class _NewoneState extends State<Newone> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(),
      body: Center(child: Text('Welcome to the Homepage'.tr().toString())),
      drawer: Consumer<ThemeProvider>(builder: (context, ThemeProvider themeProvider, child) {
        return Drawer(
          child: ListView(
            padding: const EdgeInsets.only(top: SSizes.defaultSpace),
            children: [
                  ...
                  Row(
                    children: [
                      Checkbox(
                        ...
                        onChanged: (value) async {
                          if (value != null) {
                            bool success = await themeProvider?.setThemeMode(ThemeMode.system) ?? false;
                            if (success) {
                              darkvalue = false;
                              lightvalue = false;
                            }
                  ...
                  Row(
                    children: [
                      Checkbox(
                        ...
                        onChanged: (value) async {
                          if (value != null) {
                            bool success = await themeProvider?.setThemeMode(ThemeMode.dark) ?? false;
                            if (success) {
                              systemvalue = false;
                              lightvalue = false;
                            }
                  ...
                  Row(
                    children: [
                      Checkbox(
                        ...
                        onChanged: (value) async {
                          if (value != null) {
                            bool success = await themeProvider?.setThemeMode(ThemeMode.light) ?? false;
                            if (success) {
                              systemvalue = false;
                              darkvalue = false;
                            }
